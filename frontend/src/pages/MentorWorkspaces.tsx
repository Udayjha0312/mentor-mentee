    ...
    <div className="space-y-6">
      <div className="rounded-3xl p-6 shadow-sm">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Mentor Workspaces</p>
            <h2 className="mt-2 text-2xl font-semibold">Manage your mentoring workspaces</h2>
            <p className="mt-2 text-slate-600">Create and oversee workspaces for guiding mentees and tracking progress.</p>
          </div>
          <button
...
export default MentorWorkspacesPage;