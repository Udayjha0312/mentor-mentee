...
function DashboardPage() {
  ...
  const highlights = useMemo(
    () => [
      { label: 'At-risk students', value: 234, tone: 'from-sky-500 to-indigo-500' },
      { label: 'Average attendance', value: '88%', tone: 'from-fuchsia-500 to-purple-500' },
      { label: 'Interventions logged', value: 156, tone: 'from-emerald-500 to-cyan-500' }
    ],
    []
  );

  const spotlightRows = [
    { name: 'PER 1', risk: 'High', status: 'Needs follow-up', last: '2h ago' },
    { name: 'PER 2', risk: 'Medium', status: 'Stable', last: '5h ago' },
    { name: 'PER 3', risk: 'Medium', status: 'In review', last: '1d ago' },
    { name: 'PER 4', risk: 'High', status: 'Meeting scheduled', last: '3d ago' },
    { name: 'PER 5', risk: 'Medium', status: 'On track', last: '4d ago' }
  ];
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-slate-500">At-Risk Student Spotlight</p>
        ...
        <div className="space-y-6">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div className="mt-8 grid gap-4">
              ...
              <div className="rounded-3xl bg-slate-950/5 p-5">
                <p className="text-sm text-slate-500">Academic decline</p>
                <div className="mt-3 h-3 overflow-hidden rounded-full bg-slate-200">
                  <div className="h-full w-28 rounded-full bg-indigo-500" />
                </div>
              </div>
              <div className="rounded-3xl bg-slate-950/5 p-5">
                <p className="text-sm text-slate-500">Behavioral issue</p>
                <div className="mt-3 h-3 overflow-hidden rounded-full bg-slate-200">
          ...
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm uppercase tracking-[0.3em] text-slate-500">Project health</p>
